/*
  ...
  - You are about to drop the column `documentoDoc_controle` on the `Financeiro` table. All the data in the column will be lost.
  - You are about to drop the column `pago` on the `Financeiro` table. All the data in the column will be lost.
...
INSERT INTO "new_Financeiro" ("Cliente_id", "cancelado", "dt_create", "dt_vencimento", "fin_id", "forma_pagPag_id", "usuarioId", "valor") SELECT "Cliente_id", "cancelado", "dt_create", "dt_vencimento", "fin_id", "forma_pagPag_id", "usuarioId", "valor" FROM "Financeiro";
